...
#include "mastering_ros_demo/Demo_actionAction.h"
#include <iostream>
#include <sstream>
...
protected:
  ...
  actionlib::SimpleActionServer<mastering_ros_demo::Demo_actionAction> as; 
  // create messages that are used to published feedback/result
  mastering_ros_demo::Demo_actionFeedback feedback;
  mastering_ros_demo::Demo_actionResult result;
...
public:
  ...
  void executeCB(const mastering_ros_demo::Demo_actionGoalConstPtr &goal)
  {
